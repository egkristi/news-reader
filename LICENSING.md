# News Reader — Licensing

News Reader uses a **dual-license model**: open source for the community,
...
1. Use News Reader commercially with **>50 users** and **>$5M revenue/year**
2. Distribute News Reader inside a product **without** releasing your source under AGPLv3
3. Offer News Reader as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer News Reader
...
Open an issue: https://github.com/egkristi/news-reader/issues
